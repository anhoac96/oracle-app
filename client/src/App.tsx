    ...
    <div className={`flex flex-col bg-white border border-slate-200 shadow-sm rounded-xl overflow-hidden w-full ${fullPage ? 'h-[calc(100vh-9rem)]' : 'h-[430px]'}`}>
      ...
      <div className="flex items-center gap-3 px-4 py-3 border-b border-slate-100 bg-white shrink-0">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-blue-500 font-medium italic">Gemini 1.5 Pro • Đang đồng bộ Telegram</p>
        </div>
...
export default function App() {
  ...
  const [chatLog, setChatLog] = useState<Array<{ role: string; text: string }>>([{ role: 'ai', text: 'Chào bạn! Tôi là Trợ lý AI được vận hành bởi Gemini 1.5 Pro qua OpenClaw. Tôi đã sẵn sàng hỗ trợ bạn!' }]);
