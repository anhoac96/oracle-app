function showNCB() {
  document.getElementById('content').innerHTML = `
    <div>
      <h2>Danh sách TKDT NCB đủ điều kiện</h2>
      ...
      <label><b>Số lượng TKDT:</b>(Không điền mặc định 30 TKDT)</label>
      <input type="number" id="p_limit" style="width:60px; padding:5px" placeholder="30" min="1" max="50">

      <button onclick="loadNCB()" class="primary">Tải dữ liệu</button>
